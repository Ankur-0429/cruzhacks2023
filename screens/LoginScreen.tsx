    ...
    return (
        <View style={styles.container}>
            <KeyboardAvoidingScrollView contentContainerStyle={styles.container}>    
                ...
                <Button style={{backgroundColor: Colors.constants.secondary, marginTop: 15, width: 70, borderRadius: 10, marginRight: 10, marginLeft: 'auto'}} onPress={() => console.log("hello world")}>Login</Button>
            ...
            <View style={{marginTop: 'auto', marginBottom: 50, flexDirection: 'row'}}>
                ...
                <TouchableOpacity onPress={() => {navigation.navigate("Register")}}>
                    <Text style={{color: Colors.constants.secondary, marginLeft: 5}}>Sign Up</Text>
                </TouchableOpacity>
            </View>
